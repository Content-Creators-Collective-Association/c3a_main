            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-20">
                    <h2 className="text-4xl font-extrabold mb-6 text-charcoal">
                        Professional Support, <span className="text-blue-600">Premium Access</span>
                    </h2>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    <div className="p-10 rounded-3xl bg-white border border-charcoal/5 hover:border-blue-200 transition-all">
                        <div className="w-12 h-12 rounded-xl bg-blue-100 text-blue-600 flex items-center justify-center mb-8">
